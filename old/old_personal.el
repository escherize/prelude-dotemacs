...
(add-to-list 'prelude-packages 'cljr-helm)
...
(defun my-clojure-mode-hook ()
  ...
  (define-key clojure-mode-map (kbd "C-c C-m") 'cljr-helm)
...
(global-set-key (kbd "C-c C-j") 'highlight-symbol)
...
(defun load-damned-ns ()
  (interactive)
  (insert  "(do
              (load-file \"test/unit/rdp/helpers.clj\")
              (load-file \"test/unit/rdp/server/test_utils.clj\")
              (load-file \"test/unit/rdp/web_client/re_frame_test_utils.clj\")
              (load-file \"test/unit/rdp/server/afm_test.clj\"))"))
